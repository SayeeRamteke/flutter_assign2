...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: LayoutBuilder(
          builder: (context, constraints) {
            // Experiment 3 breakpoint: mobile < 600dp,
            // tablet/web >= 600dp.
      ...
      // Mobile uses the original bottom navigation.
      // Tablet/web uses NavigationRail above.
          ...
          child: Column(
            ...
            children: [
              ...
              if (!isWide) ...[
                ...
                // Tablet/web: use a wider two-panel structure.
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Expanded(
                    ...
                    Expanded(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          buildSectionHeader("Browse", "Wrap"),
                          const SizedBox(height: 12),
                          _buildScrollableGenreRow(),
  ...
  Widget _buildScrollableGenreRow() {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        if (isWide) {
          // Wrap allows chips to move to another line when space is limited.
          return Wrap(
            spacing: 9,
            runSpacing: 9,
            children: [
    ...
    return Padding(
      ...
      child: OrientationBuilder(
        builder: (context, orientation) {
          ...
          // Portrait keeps the compact two-column mobile structure.
          // Landscape/wider screens show more cards at once.
          final int columns = orientation == Orientation.portrait
              ? (width >= 600 ? 3 : 2)
              : 4;
          ...
          return GridView.builder(
            ...
            gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
              ...
              crossAxisSpacing: width >= 600 ? 14 : 13,
              mainAxisSpacing: 18,
              childAspectRatio: width >= 600 ? 0.62 : 0.57,
            ),
...
class MovieSearchDelegate
  ...
  Widget buildResults(
    ...
    final results = movies.where((movie) {
      // Inside joke: "aggressive love" searches for Leviticus.
      if (searchQuery == "aggressive love") {
        return movie.title.toLowerCase() == "leviticus";
      }
